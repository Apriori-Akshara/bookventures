      ...
      <div className={styles.first}>
        ...
        <div className={styles.info}>
          ...
          <p>Bring your ideas and find a community that cares <br /><br />
             ...
             Bookventures offers its members to create their own community of bibliophiles by enabling them to create and join book clubs according to their own preferences. Be it thrillers, dystopian novels, crime fiction, or historical fiction or even to create a book club of their favourite series or author(s), Bookventures has something for readers of all age groups. The virtual set up allows for greater flexibility and convenience for all our members. 
             </p>
      ...
      <div className={styles.sec}>
        ...
        <div className={styles.info}>
          ...
          <p>Discover new avenues for exploration<br /><br />
             ...
             Our vitrual book clubs are open to readers all across the country but it our goal to have offline events across the country. So, our members will not just be able to participate in online and offline literary events, such as meet the author, creative writing, literary quizzes, and several other engaging activities without paying the registration fee. <br /> <br />
